...
<head>
        ...
        <!-- Bootstrap Css -->
        <link rel="stylesheet" href="{{asset('assets/admin/css/bootstrap.min.css')}}" id="bootstrap-style')}}"  type="text/css" />
        <!-- Icons Css -->
        <link rel="stylesheet" href="{{asset('assets/admin/css/icons.min.css')}}" type="text/css" />
        <!-- App Css-->
        <link rel="stylesheet" href="{{asset('assets/admin/css/app.min.css')}}" id="app-style" type="text/css" />
